      ...
      >
        ...
        <div className="flex flex-col justify-between h-[85vh] p-4">
          <ul className="text-black uppercase">
            <Link to={'/home'}><li className="p-4 border-b border-gray-600 cursor-pointer hover:text-[#0033E7]">
              Home
            </li></Link>
            <Link to={'/propertyList'}><li className="p-4 border-b border-gray-600 cursor-pointer hover:text-[#0033E7]">
              Property List
            </li></Link>
